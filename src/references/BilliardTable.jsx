...
const BilliardTable = () => {
      ...
      if (editMode && currentTable) {
        ...
        const { error } = await supabase
          ...
          .update({
            ...
            table_image: imageBase64 || currentTable.table_image
          })
  ...
  const filteredTables = tables.filter(table =>
    ...
    table.table_code?.toLowerCase().includes(searchTerm.toLowerCase())
  );
            ...
            <form onSubmit={handleSubmit} style={{ padding: '20px' }}>
              {editMode && currentTable && (
                <div style={{
                  ...
                  <span style={{ fontSize: '13px', color: '#666', fontWeight: '600' }}>Table Code:</span>
                  <span style={{
                    marginLeft: '10px',
                    fontSize: '14px',
                    fontWeight: '700',
